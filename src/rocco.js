 ...
 */
var rocco_template  = template(fs.readFileSync(__dirname + '/../resources/rocco.jst').toString());

/**
 * The CSS styles we'd like to apply to the documentation.
 */
var rocco_styles    = fs.readFileSync(__dirname + '/../resources/rocco.css').toString();
